...
public class RenderUtil implements Global {
    ...
    public static void drawPenis(EntityPlayer player, double x, double y, double z, float spin, float cumsize, float amount) {
        ...
        GL11.glRotated((float) (player.isSneaking() ? 35 : 0) + spin, 1.0F + spin, 0.0D, cumsize);
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) Revenge.fontManager.getStringWidth(text) / 2.0D), 0.0D, 0.0D);
